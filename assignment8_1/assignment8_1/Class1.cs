...
namespace assignment8_1
{
    internal class EmployeeWage
    {
        ...
        public static int CheckAttendance(int number)
        {
            ...
            switch(number)
            {
                case 0: Console.WriteLine("Empoyee is absent");
                        salary = WagePerHour * 0;
                    break;
                case 1: Console.WriteLine("Employee is present part time");
                    salary = WagePerHour * 4;
                    break;
                case 2: Console.WriteLine("Employee is present full time");
